			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="about-item-img">
						<img loading="lazy" src="{{ asset('MegaKit/images/about/home-7.jpg') }}" alt="about-image" class="img-fluid">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="team-item-wrap mb-5">
						<div class="team-item position-relative">
							<img loading="lazy" src="{{ asset('MegaKit/images/team/team-1.jpg') }}" alt="team" class="img-fluid w-100">
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="team-item-wrap mb-5">
						<div class="team-item position-relative">
							<img loading="lazy" src="{{ asset('MegaKit/images/team/team-2.jpg') }}" alt="team" class="img-fluid w-100">
							<div class="team-img-hover">
								<ul class="team-social list-inline">
									<li class="list-inline-item">
										<a href="javascript:void(0);" class="facebook"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="team-item-wrap mb-5 ">
						<div class="team-item position-relative">
							<img loading="lazy" src="{{ asset('MegaKit/images/team/team-3.jpg') }}" alt="team" class="img-fluid w-100">
							<div class="team-img-hover">
								<ul class="team-social list-inline">
									<li class="list-inline-item">
										<a href="javascript:void(0);" class="facebook"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="team-item-wrap mb-5 mb-lg-0">
						<div class="team-item position-relative">
							<img loading="lazy" src="{{ asset('MegaKit/images/team/team-4.jpg') }}" alt="team" class="img-fluid w-100">
							<div class="team-img-hover">
								<ul class="team-social list-inline">
									<li class="list-inline-item">
										<a href="javascript:void(0);" class="facebook"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="team-item-wrap mb-5 mb-lg-0">
						<div class="team-item position-relative">
							<img loading="lazy" src="{{ asset('MegaKit/images/team/team-6.jpg') }}" alt="team" class="img-fluid w-100">
							<div class="team-img-hover">
								<ul class="team-social list-inline">
									<li class="list-inline-item">
										<a href="javascript:void(0);" class="facebook"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="team-item-wrap mb-5 mb-lg-0 ">
						<div class="team-item position-relative">
							<img loading="lazy" src="{{ asset('MegaKit/images/team/team-5.jpg') }}" alt="team" class="img-fluid w-100">
							<div class="team-img-hover">
								<ul class="team-social list-inline">
									<li class="list-inline-item">
										<a href="javascript:void(0);" class="facebook"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
